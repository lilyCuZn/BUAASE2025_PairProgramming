async function instantiate(module, imports = {}) {
  ...
  const adaptedExports = Object.setPrototypeOf({
    greedy_snake_step(n, snake, snake_num, snakes, food_num, foods, round) {
      ...
      snakes = __retain(__lowerArray(__setU32, 4, 2, snakes) || __notnull());
      foods = __lowerArray(__setU32, 4, 2, foods) || __notnull();
      try {
        return exports.greedy_snake_step(n, snake, snake_num, snakes, food_num, foods, round);
      } finally {
        __release(snake);
        __release(snakes);
      }
